...
App.propTypes = {
  ...
  levelFinish: PropTypes.array,
  levelAnswer: PropTypes.array,
  stopSound: PropTypes.number,
  hoverColor: PropTypes.array,
  buttonInput: PropTypes.array,
  onlyUserInput: PropTypes.bool,
  setLevel: PropTypes.func,
  startGame: PropTypes.func,
  createAnswer: PropTypes.func,
  getButtonInput: PropTypes.func,
}
